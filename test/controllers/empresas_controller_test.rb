...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { cnpj: @empresa.cnpj, endereco: @empresa.endereco, nome: @empresa.nome, qtd_empregados: @empresa.qtd_empregados, tel_contato: @empresa.tel_contato } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cnpj: @empresa.cnpj, endereco: @empresa.endereco, nome: @empresa.nome, qtd_empregados: @empresa.qtd_empregados, tel_contato: @empresa.tel_contato } }
