...
class ItinerariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerario" do
    assert_difference('Itinerario.count') do
      post itinerarios_url, params: { itinerario: { estacao_id: @itinerario.estacao_id, linha_id: @itinerario.linha_id, ordem: @itinerario.ordem } }
    end
  ...
  test "should update itinerario" do
    patch itinerario_url(@itinerario), params: { itinerario: { estacao_id: @itinerario.estacao_id, linha_id: @itinerario.linha_id, ordem: @itinerario.ordem } }
